	...
	tests := []urlTest{
		{
			...
			goarch:      "amd64",
			goos:        "linux",
			expectedURL: "https://github.com/MetalBlockchain/metalgo/releases/download/v1.17.1/avalanchego-linux-amd64-v1.17.1.tar.gz",
		...
		},
		{
			...
			goarch:      "arm64",
			goos:        "darwin",
			expectedURL: "https://github.com/MetalBlockchain/metalgo/releases/download/v1.18.5/avalanchego-macos-v1.18.5.zip",
		...
		},
		{
			...
			goarch:      "amd64",
			goos:        "windows",
			expectedURL: "https://github.com/MetalBlockchain/metalgo/releases/download/v2.1.4/avalanchego-win-v2.1.4-experimental.zip",
			expectedExt: zipExtension,
			expectedErr: nil,
		},
		{
