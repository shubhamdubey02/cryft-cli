...
func TestGetGithubLatestReleaseURL(t *testing.T) {
	...
	expected := "https://api.github.com/repos/cryft-labs/cryftgo/releases/latest"
	...
	tests := []urlTest{
		{
			...
			goarch:      "amd64",
			goos:        "linux",
			expectedURL: "https://github.com/cryft-labs/cryftgo/releases/download/v1.17.1/metalgo-linux-amd64-v1.17.1.tar.gz",
		...
		},
		{
			...
			goarch:      "arm64",
			goos:        "darwin",
			expectedURL: "https://github.com/cryft-labs/cryftgo/releases/download/v1.18.5/metalgo-macos-v1.18.5.zip",
		...
		},
		{
			...
			goarch:      "amd64",
			goos:        "windows",
			expectedURL: "https://github.com/cryft-labs/cryftgo/releases/download/v2.1.4/metalgo-win-v2.1.4-experimental.zip",
			expectedExt: zipExtension,
			expectedErr: nil,
		},
		{
	...
	tests := []urlTest{
		{
			...
			goarch:      "amd64",
			goos:        "linux",
			expectedURL: "https://github.com/shubhamdubey02/subnet-evm/releases/download/v1.17.1/subnet-evm_1.17.1_linux_amd64.tar.gz",
			expectedExt: tarExtension,
			expectedErr: nil,
		},
		{
			...
			goarch:      "arm64",
			goos:        "darwin",
			expectedURL: "https://github.com/shubhamdubey02/subnet-evm/releases/download/v1.18.5/subnet-evm_1.18.5_darwin_arm64.tar.gz",
			expectedExt: tarExtension,
			expectedErr: nil,
		},
		{
