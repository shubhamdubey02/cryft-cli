...
var (
	createSupportedNetworkOptions         = []networkoptions.NetworkOption{networkoptions.Tahoe, networkoptions.Devnet}
...
func createNodes(cmd *cobra.Command, args []string) error {
	...
	ux.Logger.PrintToUser("Installing MetalGo and Cryft-cli and starting bootstrap process on the newly created Metal node(s)...")
	wg := sync.WaitGroup{}
